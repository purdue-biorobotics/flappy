...
class PIDController():
	def __init__(self,dt):
		...
		self.pid_vel_z_.Kp = 40#10
		self.pid_vel_z_.Ki = 0#4
		self.pid_vel_z_.Kd = 0.16#0.04
		self.pid_vel_z_.p = 0
		self.pid_vel_z_.i= 0
		self.pid_vel_z_.d = 0
		...
		self.pid_vel_y_.Kp = 2#1.75
		self.pid_vel_y_.Ki = 0#0.4
		self.pid_vel_y_.Kd = 0.004#0.002
		self.pid_vel_y_.p = 0
		self.pid_vel_y_.i= 0
		self.pid_vel_y_.d = 0
		...
		self.pid_ang_roll_.Kp = 4#3
		self.pid_ang_roll_.Ki = 0#1.5
		self.pid_ang_roll_.Kd = 0.6#0.4
		...
		self.pid_ang_yaw_.Kp = 0.4
		self.pid_ang_yaw_.Ki = 0#0.15
		self.pid_ang_yaw_.Kd = 0.001
	...
	def get_action(self, states, dt, reached):
		if reached == 1:
			self.p_pos_xy_Kp_ = 7
		self.dt_ = dt
